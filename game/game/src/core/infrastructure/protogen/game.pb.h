...
// string seed = 8;
inline void GameSnapshotNotify::clear_seed() {
  _impl_.seed_.ClearToEmpty();
}
inline const std::string& GameSnapshotNotify::seed() const {
  // @@protoc_insertion_point(field_get:proto.GameSnapshotNotify.seed)
  return _internal_seed();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GameSnapshotNotify::set_seed(ArgT0&& arg0, ArgT... args) {
 
 _impl_.seed_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:proto.GameSnapshotNotify.seed)
}
inline std::string* GameSnapshotNotify::mutable_seed() {
  std::string* _s = _internal_mutable_seed();
  // @@protoc_insertion_point(field_mutable:proto.GameSnapshotNotify.seed)
  return _s;
}
inline const std::string& GameSnapshotNotify::_internal_seed() const {
  return _impl_.seed_.Get();
}
inline void GameSnapshotNotify::_internal_set_seed(const std::string& value) {
  
  _impl_.seed_.Set(value, GetArenaForAllocation());
}
inline std::string* GameSnapshotNotify::_internal_mutable_seed() {
  
  return _impl_.seed_.Mutable(GetArenaForAllocation());
}
inline std::string* GameSnapshotNotify::release_seed() {
  // @@protoc_insertion_point(field_release:proto.GameSnapshotNotify.seed)
  return _impl_.seed_.Release();
}
inline void GameSnapshotNotify::set_allocated_seed(std::string* seed) {
  if (seed != nullptr) {
    
  } else {
    
  }
  _impl_.seed_.SetAllocated(seed, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.seed_.IsDefault()) {
    _impl_.seed_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:proto.GameSnapshotNotify.seed)
}

// string hash = 9;
inline void GameSnapshotNotify::clear_hash() {
  _impl_.hash_.ClearToEmpty();
}
inline const std::string& GameSnapshotNotify::hash() const {
  // @@protoc_insertion_point(field_get:proto.GameSnapshotNotify.hash)
  return _internal_hash();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void GameSnapshotNotify::set_hash(ArgT0&& arg0, ArgT... args) {
 
 _impl_.hash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:proto.GameSnapshotNotify.hash)
}
inline std::string* GameSnapshotNotify::mutable_hash() {
  std::string* _s = _internal_mutable_hash();
  // @@protoc_insertion_point(field_mutable:proto.GameSnapshotNotify.hash)
  return _s;
}
inline const std::string& GameSnapshotNotify::_internal_hash() const {
  return _impl_.hash_.Get();
}
inline void GameSnapshotNotify::_internal_set_hash(const std::string& value) {
  
  _impl_.hash_.Set(value, GetArenaForAllocation());
}
inline std::string* GameSnapshotNotify::_internal_mutable_hash() {
  
  return _impl_.hash_.Mutable(GetArenaForAllocation());
}
inline std::string* GameSnapshotNotify::release_hash() {
  // @@protoc_insertion_point(field_release:proto.GameSnapshotNotify.hash)
  return _impl_.hash_.Release();
}
inline void GameSnapshotNotify::set_allocated_hash(std::string* hash) {
  if (hash != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:proto.GameSnapshotNotify.hash)
}
...
// int32 playType = 6;
inline void MinesPlaceBetRes::clear_playtype() {
  _impl_.playtype_ = 0;
}
inline int32_t MinesPlaceBetRes::_internal_playtype() const {
  return _impl_.playtype_;
}
inline int32_t MinesPlaceBetRes::playtype() const {
  // @@protoc_insertion_point(field_get:proto.MinesPlaceBetRes.playType)
  return _internal_playtype();
}
inline void MinesPlaceBetRes::_internal_set_playtype(int32_t value) {
  
  _impl_.playtype_ = value;
}
inline void MinesPlaceBetRes::set_playtype(int32_t value) {
  _internal_set_playtype(value);
  // @@protoc_insertion_point(field_set:proto.MinesPlaceBetRes.playType)
}
...
// string hash = 4;
inline void MinesStartJettonNotify::clear_hash() {
  _impl_.hash_.ClearToEmpty();
}
inline const std::string& MinesStartJettonNotify::hash() const {
  // @@protoc_insertion_point(field_get:proto.MinesStartJettonNotify.hash)
  return _internal_hash();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MinesStartJettonNotify::set_hash(ArgT0&& arg0, ArgT... args) {
 
 _impl_.hash_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:proto.MinesStartJettonNotify.hash)
}
inline std::string* MinesStartJettonNotify::mutable_hash() {
  std::string* _s = _internal_mutable_hash();
  // @@protoc_insertion_point(field_mutable:proto.MinesStartJettonNotify.hash)
  return _s;
}
inline const std::string& MinesStartJettonNotify::_internal_hash() const {
  return _impl_.hash_.Get();
}
inline void MinesStartJettonNotify::_internal_set_hash(const std::string& value) {
  
  _impl_.hash_.Set(value, GetArenaForAllocation());
}
inline std::string* MinesStartJettonNotify::_internal_mutable_hash() {
  
  return _impl_.hash_.Mutable(GetArenaForAllocation());
}
inline std::string* MinesStartJettonNotify::release_hash() {
  // @@protoc_insertion_point(field_release:proto.MinesStartJettonNotify.hash)
  return _impl_.hash_.Release();
}
inline void MinesStartJettonNotify::set_allocated_hash(std::string* hash) {
  if (hash != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:proto.MinesStartJettonNotify.hash)
}
